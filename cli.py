...
def main():
    ...
    parser.add_argument("--common", default="../data/common_passwords.txt",
                        help="Path to common passwords file")
    args = parser.parse_args()

    pw = args.password or getpass.getpass("Enter a password to check (input hidden): ")
    result = evaluate_password(pw, load_common_passwords(args.common))
